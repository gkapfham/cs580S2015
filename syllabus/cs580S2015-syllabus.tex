...
\item {\em Writing and Practical Skill Assignments:} For each of the assigned research articles, a student will be
  ...
  %The paper reviews, the precis documents, and the practical skill assignments will be graded by the course instructors.
...
\item {\em Research Presentations:} During each module of the course, a team of students will give a forty to fifty
  ...
  %the module professor.  The module professor and the course instructor will collaboratively assign a grade to your
%presentations in a module.
...
\centering
  ...
  \begin{minipage}{2.1in}
    {\bf Topic}: {\small Write \& edit presentation} \\
